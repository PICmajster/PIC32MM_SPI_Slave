...
/**
  ...
  @Description
    Sets or Resets the GPIO pin, RA9, low or high using LATAbits.LATA9.
...
*/
#define SCK2IN_SetHigh()          ( LATBSET = (1 << 8) )
/**
  @Summary
...
*/
#define SCK2IN_SetLow()           ( LATBCLR = (1 << 8) )
...
/**
  ...
  @Example
    <code>
    // Set RB8 to low.
    SCK2IN_SetValue(false);
    </code>

*/
inline static void SCK2IN_SetValue(bool value)
{
  if(value)
  {
    SCK2IN_SetHigh();
...
*/
#define SCK2IN_Toggle()           ( LATBINV = (1 << 8) )
/**
  @Summary
  ...
  @Example
    ...
    // Read RB8
    postValue = SCK2IN_GetValue();
    </code>

*/
#define SCK2IN_GetValue()         PORTBbits.RB8
/**
  @Summary
  ...
  @Example
    ...
    SCK2IN_SetDigitalInput();
    </code>

*/
#define SCK2IN_SetDigitalInput()   ( TRISBSET = (1 << 8) )
/**
  @Summary
  ...
  @Example
    ...
    SCK2IN_SetDigitalOutput();
    </code>

*/
#define SCK2IN_SetDigitalOutput()   ( TRISBCLR = (1 << 8) )
/**
  @Summary
